<div class="wrap-search center-section">
	<div class="wrap-search-form">
		<form action="{{ route('product.search') }}" id="form-search-top" name="form-search-top">
				...
				<input type="hidden" name="product_cat" value="{{ $product_category }}" id="product-cat">
				<input type="hidden" name="product_cat_id" value="{{ $product_category_id }}" id="product-cat_id">
